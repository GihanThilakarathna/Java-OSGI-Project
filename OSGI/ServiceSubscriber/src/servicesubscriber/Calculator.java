...
public class Calculator implements ActionListener {
	...
	Calculator(ServicePublish servicePublish) {
	...
	public void addComponents() {
		...
		buttonClear.setBounds(10, 170, 200, 40);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (source == buttonClear) {
			...
			case 1:
				// using the service
				answer = servicePublish.calculate(number, Double.parseDouble(textField.getText()), '+');
